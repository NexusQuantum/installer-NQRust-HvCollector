...
const SERVICE_CONFIGS: &[ServiceConfig] = &[
    ...
    ServiceConfig {
        display_name: "Fluentd (HV Collector)",
        image: "ghcr.io/nexusquantum/fluentd-hypervisor-collector",
...
async fn fetch_installer_update(client: &Client) -> Result<Option<UpdateInfo>> {
    let url = format!(
        "https://api.github.com/repos/{owner}/installer-NQRust-HvCollector/releases/latest",
        owner = OWNER
    );
